...
\newfontfamily\cyrillicfonttt{Libertinus Mono}
...
\newtheorem*{notet}{Примечание техающего}
...
\crefname{note}{примечание}{примечания}
\Crefname{note}{Примечание}{Примечания}
...
\newpagestyle{main}{
    \setheadrule{0.4pt}
    \sethead{Функциональный анализ}{}{\hyperlink{intro}{\;Назад к содержанию}}
    \setfootrule{0.4pt}
...
%\newcommand{\nxrightarrow}[1][]{\mathrel{\xrightarrow[#1]{\phantom{#1}}}\mathrel{\mkern-24mu}\not\phantom{\xrightarrow[#1]{}}}

\newcommand{\xcancelrightarrow}[1]{%
    \mathrel{%
