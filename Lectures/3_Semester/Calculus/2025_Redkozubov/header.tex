...
%%% Разное
\usepackage{caption}
\usepackage{soul, mathrsfs, dsfont}
...
\newcommand{\LecturerInitials}{Редкозубов Вадим Витальевич}
\newcommand{\CourseDate}{осень 2025}
\newcommand{\AuthorInitials}{Александр Белов}
\newcommand{\VKLink}{https://t.me/tandalganoli}
...
%%% Доп. окружения
\newenvironment{myproof}{\noindent\textcolor{black}{$\blacktriangle$} }{\hfill{ $\blacksquare$}\par}
...
\newenvironment{prooflemma}{\noindent\textcolor{black}{$\triangle$} }{\hfill{ $\qed$}\par}