\section{Преамбула к 7 лекции}[ht]
\begin{definition}
...
\vspace{.7cm}
\hfill \includegraphics*[scale = .5]{images/decarts-1.pdf} \hfill	\includegraphics*[scale = 2]{images/decarts-2.pdf} \hfill 
\vspace{.7cm}
...
\begin{figure}[h]
	...
	\begin{subfigure}[b!]{0.4\linewidth}
		\centering
		\includegraphics[scale=1]{images/decarts-3.pdf}
...
\begin{figure}[h]
	...
	\begin{subfigure}[b!]{0.4\linewidth}
		\centering
		\includegraphics[scale=.5]{images/decarts-5.pdf}
...
\begin{proof}
	\begin{figure}[h]
		...
		\begin{subfigure}[b!]{0.4\linewidth}
			\centering
			\includegraphics[scale=.7]{images/decarts-4.pdf}
...
\begin{figure}[h]
	...
	\begin{subfigure}[b!]{0.4\linewidth}
		\centering
		\includegraphics[scale=1]{images/decarts-6.pdf}
...
\begin{enumerate}
	...
	\begin{figure}[h]
		...
		\begin{subfigure}[b!]{0.4\linewidth}
			\centering
			\includegraphics[scale=1]{images/decarts-7.pdf}
	...
	\begin{figure}[h]
		...
		\begin{subfigure}[b!]{0.4\linewidth}
			\centering
			\includegraphics[scale=1]{images/decarts-8.pdf}
...
\begin{figure}[h]
	...
	\begin{subfigure}[b!]{0.4\linewidth}
		\centering
		\includegraphics[scale=.4]{images/decarts-9.pdf}
...
\vspace{.7cm}
\hfill \includegraphics*[scale = 1]{images/apps-1.pdf} \hfill	\includegraphics*[scale = 1]{images/apps-2.pdf} \hfill 
\vspace{.7cm}
...
\end{proof}
\subsection{Приложения к стереометрии}
\begin{enumerate}
	...
	\begin{figure}[h]
		...
		\begin{subfigure}[b!]{0.4\linewidth}
			\centering
			\includegraphics[scale=.5]{images/apps-3.pdf}
	...
	\end{pmatrix}: \rho = \dfrac{|A(x-x_0)+B(y-y_0)+C(z-z_0)|}{\sqrt{A^2+B^2+C^2}} = \dfrac{||Ax+By+Cz+D}{\sqrt{A^2+B^2+C^2}}\)
		...
		\begin{figure}[h]
			\begin{subfigure}[b!]{0.4\linewidth}
				\centering
				\includegraphics[scale=1]{images/apps-4.pdf}
...
\begin{figure}[h]
	...
	\begin{subfigure}[b!]{0.4\linewidth}
		\centering
		\includegraphics[scale=2]{images/apps-5.pdf}
...
\begin{enumerate}
	\begin{figure}[h]
		...
		\begin{subfigure}[b!]{0.4\linewidth}
			\centering
			\includegraphics[scale=1]{images/apps-6.pdf}
			\caption*{Угол между прямыми}
			\label{Apps4}
		\end{subfigure}
	\end{figure}
	...
	\vspace{.7cm}
	\hfill \includegraphics*[scale = 1]{images/apps-7.pdf} \hfill	\includegraphics*[scale = .5]{images/apps-8.pdf} \hfill 
	\vspace{.7cm}
