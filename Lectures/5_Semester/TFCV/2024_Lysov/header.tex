...
\newcommand{\CourseName}{ТФКП}
\newcommand{\FullCourseNameFirstPart}{\so{ТЕОРИЯ ФУНКЦИЙ КОМПЛЕКСНОГО ПЕРЕМЕННОГО}}
\newcommand{\SemesterNumber}{V}
\newcommand{\LecturerInitials}{Лысов Владимир Генрихович}
...
\DeclareMathOperator{\Oo}{\overline O}
